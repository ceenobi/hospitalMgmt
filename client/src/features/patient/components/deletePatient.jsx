...
export default function DeletePatient({ patient, onClose, isOpen }) {
      ...
      >
        {!showSuccess ? (
          <div className="flex flex-col items-center gap-2 w-full">
            ...
            <p>
              Are you sure you want to delete patient <b>{patient?.fullname}</b>?
            </p>
          ...
          <div className="p-4 text-center max-w-[300px] mx-auto">
            ...
            <p className="text-gray-600">Patient deleted successfully.</p>
            <button
              onClick={onClose}
